...
// src/formatter.ts
var Formatter = class extends null {
  constructor() {
  }
...
var FETCH_LIBS = ["undici", "node-fetch", "cross-fetch"];
function getFetch() {
  return __async(this, null, function* () {
...
var Util = class {
  ...
  static getPlaylist(html, limit) {
    ...
    const res = new Playlist_default({
      ...
      thumbnail: ((_m = data.thumbnailRenderer.playlistVideoThumbnailRenderer) == null ? void 0 : _m.thumbnail.thumbnails.length) ? data.thumbnailRenderer.playlistVideoThumbnailRenderer.thumbnail.thumbnails[data.thumbnailRenderer.playlistVideoThumbnailRenderer.thumbnail.thumbnails.length - 1].url : null
    });
    return res;
  }
...
var YouTube = class {
  ...
  static search(query, options) {
    return __async(this, null, function* () {
      ...
      try {
        ...
        const hl = (options == null ? void 0 : options.hl) ? options == null ? void 0 : options.hl : "en";
        const gl = (options == null ? void 0 : options.gl) ? options == null ? void 0 : options.gl : "US";
        const url = `https://youtube.com/results?search_query=${encodeURIComponent(query.trim()).replace(/%20/g, "+")}&hl=${hl}&gl=${gl}${filter}`;
  ...
  static getPlaylist(url, hl, gl, options) {
    return __async(this, null, function* () {
      if (!options)
      ...
      const html = yield Util_default.getHTML(`${url}&hl=${hl != null ? hl : "en"}&gl=${gl != null ? gl : "US"}`, options && options.requestOptions);
      return Util_default.getPlaylist(html, options && options.limit);
    });
  }
  static getVideo(url, hl, gl, requestOptions) {
    return __async(this, null, function* () {
      if (!url)
      ...
      const html = yield Util_default.getHTML(`${url}&hl=${hl ? hl : "en"}&gl=${gl}`, requestOptions);
      return Util_default.getVideo(html);
    });
  }
  static homepage(hl, gl) {
    return __async(this, null, function* () {
      const html = yield Util_default.getHTML("https://www.youtube.com?hl=" + (hl ? hl : "en") + "&gl=" + (gl != null ? gl : "US"));
  ...
  static trending(hl, gl) {
    return __async(this, null, function* () {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
      const html = yield Util_default.getHTML("https://www.youtube.com/feed/explore?hl=" + (hl ? hl : "en") + "&gl=" + (gl != null ? gl : "US"));
      let json;
      try {
  ...
  static getSuggestions(query, hl, gl) {
    return __async(this, null, function* () {
      if (!query)
        throw new Error("Search query was not provided!");
      try {
        const res = yield Util_default.getHTML(`https://suggestqueries-clients6.youtube.com/complete/search?client=youtube&gs_ri=youtube&ds=yt&hl=${hl != null ? hl : "en"}&gl=${gl != null ? gl : "US"}&q=${encodeURIComponent(query)}`);
        ...
        const res = yield Util_default.getHTML(`https://clients1.google.com/complete/search?client=youtube&gs_ri=youtube&ds=yt&hl=${hl != null ? hl : "en"}&gl=${gl != null ? gl : "US"}&q=${encodeURIComponent(query)}`);
