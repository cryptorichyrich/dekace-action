...
declare class Formatter extends null {
    private constructor();
...
declare class YouTube {
    ...
    static getPlaylist(url: string, hl?: string, gl?: string, options?: PlaylistOptions): Promise<Playlist>;
    static getVideo(url: string | Video, hl?: string, gl?: string, requestOptions?: RequestInit): Promise<Video>;
    static homepage(hl?: string, gl?: string): Promise<Video[]>;
    static fetchInnerTubeKey(): Promise<string>;
    static trending(hl?: string, gl?: string): Promise<Video[]>;
    static getSuggestions(query: string, hl: string, gl: string): Promise<any[]>;
...
export { Channel, ChannelIconInterface, Formatter, Playlist, PlaylistOptions, SAFE_SEARCH_COOKIE, SearchOptions, Thumbnail, Util, Video, VideoStreamingData, VideoStreamingFormat, VideoStreamingFormatAdaptive, YouTube, YouTube as default };
